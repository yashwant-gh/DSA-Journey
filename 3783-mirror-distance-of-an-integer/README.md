<h2><a href="https://leetcode.com/problems/mirror-distance-of-an-integer/?envType=problem-list-v2&envId=math">3783. Mirror Distance of an Integer</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code>.</p>
